...
For examples see the file `examples_server.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for complete server examples.
...
For examples see the file `examples_integration.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for complete Views/Profiles/Scopes implementation.
...
For examples see the file `examples_client.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for complete client examples.
...
For examples see the file `examples_client.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for display utility implementation.
...
For examples see the file `examples_integration.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for single server architecture.
...
For examples see the file `examples_integration.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for complete filtering implementation.
...
For examples see the file `examples_integration.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for dynamic discovery pattern.
...
For examples see the file `examples_integration.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for prompt generation examples.
...
For examples see the file `examples_integration.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for complete orchestration pattern.
...
See rule: data-schemas-and-interfaces (in .amazonq/rules) for Pydantic schema standards.
...
See rule: security-governance-and-observability (in .amazonq/rules) for security standards.
...
See rule: performance-optimization (in .amazonq/rules) for performance strategies.
...
- rule: api-interface-and-streaming (in .amazonq/rules) - API patterns and streaming
- rule: agentic-logic-and-tools (in .amazonq/rules) - Tool design patterns
- rule: data-schemas-and-interfaces (in .amazonq/rules) - Pydantic schema standards
- rule: core-python-standards (in .amazonq/rules) - Code quality standards
- rule: error-handling-and-resilience (in .amazonq/rules) - Error handling patterns
- rule: security-governance-and-observability (in .amazonq/rules) - Security standards
- rule: performance-optimization (in .amazonq/rules) - Performance strategies

...
* **FastAPI Integration:**
    ...
    * **Customization:** Enhance auto-generated schemas with additional details; use `response_model`, `tags`, and `openapi_tags` to improve Swagger organization.
...
* **Validation:**
    ...
    * **Field Descriptions:** Include descriptions for all fields (See: (See rule: data-schemas-and-interfaces in .amazonq/rules)).
...
* See rule: versioning-and-release-management (in .amazonq/rules) for versioning standards.
...
* See rule: security-governance-and-observability (in .amazonq/rules) for security implementation details.
...
* See rule: api-interface-and-streaming (in .amazonq/rules) for rate limiting implementation details.

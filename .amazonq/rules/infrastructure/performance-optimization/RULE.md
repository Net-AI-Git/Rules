...
For examples see the file `examples_caching.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for cache-aside pattern implementation.
...
For examples see the file `examples_batching.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for batch processing pattern implementation.
...
For examples see the file `examples_connection_pooling.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for connection pool configuration pattern.
...
* **Profiling:**
    * **Application Profiling:** Use profiling tools to identify bottlenecks; send timing and metrics to **Splunk** for analysis (See rule: monitoring-and-observability (in .amazonq/rules)).
...
For examples see the file `examples_caching.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for semantic similarity detection implementation.
...
For examples see the file `examples_caching.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for similarity threshold configuration.
...
For examples see the file `examples_caching.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for cache invalidation implementation.
...
For examples see the file `examples_caching.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for cost savings calculation.
...
For examples see the file `examples_caching.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for semantic caching implementation.

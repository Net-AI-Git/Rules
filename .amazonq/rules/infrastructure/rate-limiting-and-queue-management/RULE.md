...
For examples see the file `examples_multi_agent_rate_limiting.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for per-agent rate limiting implementation.
...
For examples see the file `examples_multi_agent_rate_limiting.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for global rate limiting coordination.
...
For examples see the file `examples_queue_management.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for queue implementation patterns.
...
For examples see the file `examples_api_key_protection.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for API key management and protection patterns.
...
See rule: error-handling-and-resilience (in .amazonq/rules) for basic exponential backoff patterns.
...
For examples see the file `examples_multi_agent_rate_limiting.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for Redis-based rate limiting.
...
* See rule: error-handling-and-resilience (in .amazonq/rules) for error handling patterns.

### API Interface Integration

* **HTTP API Layer:** At the HTTP API layer, implement rate limiting via FastAPI (middleware or dependencies). See rule: api-interface-and-streaming (in .amazonq/rules). This rule covers agent-level and queue-level rate limiting; API-level rate limiting is defined there.
...
* See rule: monitoring-and-observability (in .amazonq/rules) for monitoring patterns.

...
For examples see the file `examples_input_sanitization.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for sanitization patterns and implementation.
...
For examples see the file `examples_injection_detection.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for detection methods and patterns.
...
For examples see the file `examples_validation_patterns.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for validation patterns and rules.
...
* **Audit Logging:** Log all sanitization and detection events using **structlog** for structured logging.

...
See rule: rules-management (in .amazonq/rules) for the main rules management guide.
...
For complete server implementation examples, see: `examples_server.py` (in this folder; add to chat context when needed)
...
For examples see the file `examples_basic.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for complete basic implementation examples.

### Pattern 2: Advanced Patterns

[Brief explanation]

For examples see the file `examples_advanced.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for advanced pattern examples.

## Complete Examples

Complete, runnable examples are provided in separate files:

- **`examples_basic.py` (in this folder; add to chat context when needed)**: Basic implementation examples
  - Pattern A
  - Pattern B
  
- **`examples_advanced.py` (in this folder; add to chat context when needed)**: Advanced patterns
  - Pattern C
  - Pattern D
...
For examples see the file `examples_server.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for complete server implementation examples.

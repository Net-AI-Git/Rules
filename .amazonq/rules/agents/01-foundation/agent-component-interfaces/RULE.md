...
See rule: contract-scope-and-boundaries (in .amazonq/rules) for when to define explicit contracts vs. implicit contracts (boundary points, replaceability test, avoiding over-engineering).
...
For examples see the file `examples_interfaces.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for ABC interface definitions for Planner, Memory, and Executor.
...
For examples see the file `examples_contracts.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for input/output contract definitions and validation patterns.
...
See rule: planner-strategic-planning (in .amazonq/rules) for Planner implementation patterns.
...
See rule: executor-action-translation (in .amazonq/rules) for Executor implementation patterns.
...
For examples see the file `examples_interfaces.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for complete ABC implementation patterns.
...
For examples see the file `examples_modularity.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for implementation swapping patterns and dependency injection.
...
* **Usage:**
  * Use Pydantic models from rule: data-schemas-and-interfaces (in .amazonq/rules) for input/output types
...
* See rule: multi-agent-systems (in .amazonq/rules) for multi-agent architecture patterns.
...
For examples see the file `examples_interfaces.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for complete ABC interface definitions for Planner, Memory, and Executor components.

For examples see the file `examples_contracts.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for input/output contract definitions and validation patterns.

For examples see the file `examples_modularity.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for implementation swapping patterns, dependency injection, and A/B testing examples.

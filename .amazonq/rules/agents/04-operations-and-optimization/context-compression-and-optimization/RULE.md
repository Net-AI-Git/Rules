...
For examples see the file `examples_compression.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for compression trigger implementation and threshold management.
...
For examples see the file `examples_compression.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for extractive and abstractive summarization implementations.
...
For examples see the file `examples_retention.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for importance scoring and retention criteria patterns.
...
For examples see the file `examples_retention.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for retention criteria and importance scoring patterns.
...
* **Transparency:** Log compression events for debugging using **structlog** with structured fields (input_tokens, output_tokens, compressed flag).

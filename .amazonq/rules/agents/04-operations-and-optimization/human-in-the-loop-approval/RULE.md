...
For examples see the file `examples_approval_context.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for ApprovalContext TypedDict definition and builder patterns.

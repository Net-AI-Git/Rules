...
For examples see the file `examples_executor_node.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for Executor node implementation following READ→DO→WRITE→CONTROL pattern.
...
For examples see the file `examples_action_translation.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for plan-to-action translation patterns and action structure.
...
For examples see the file `examples_execution_coordination.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for coordination patterns with Workers and Tools.
...
* See rule: multi-agent-systems (in .amazonq/rules) for Orchestrator and SECTIONS patterns.
...
* See rule: multi-agent-systems (in .amazonq/rules) for Worker coordination patterns.
...
* See rule: memory-feedback-node (in .amazonq/rules) for Memory Node integration patterns.
...
See rule: langgraph-architecture-and-nodes (in .amazonq/rules) for node implementation patterns and `examples_executor_node.py` (in this folder; add to chat context when needed) for complete Executor node implementation.
...
* **Interface:** Executor must implement the Executor interface from rule: agent-component-interfaces (in .amazonq/rules).
...
* See rule: agentic-logic-and-tools (in .amazonq/rules) for tool definition and usage patterns.
...
For examples see the file `examples_executor_node.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for complete Executor node implementation following READ→DO→WRITE→CONTROL pattern, including plan translation, action coordination, and result monitoring.

For examples see the file `examples_action_translation.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for plan-to-action translation patterns, action structure, and action validation.

For examples see the file `examples_execution_coordination.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for coordination patterns with Workers and Tools, parallel execution, dependency management, and result collection.

...
For examples see the file `examples_planner_node.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for Planner node implementation following READ→DO→WRITE→CONTROL pattern.
...
For examples see the file `examples_goal_setting.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for goal and sub-goal definition patterns.
...
For examples see the file `examples_risk_assessment.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for risk/cost/benefit evaluation patterns.
...
* See rule: memory-feedback-node (in .amazonq/rules) for Memory Node integration patterns and rule: memory-and-archival-management (in .amazonq/rules) for storage patterns.
...
* See rule: multi-agent-systems (in .amazonq/rules) for Orchestrator integration patterns.
...
See rule: langgraph-architecture-and-nodes (in .amazonq/rules) for node implementation patterns and `examples_planner_node.py` (in this folder; add to chat context when needed) for complete Planner node implementation.
...
* **Interface:** Planner must implement the Planner interface from rule: agent-component-interfaces (in .amazonq/rules).
...
For examples see the file `examples_planner_node.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for complete Planner node implementation following READ→DO→WRITE→CONTROL pattern.

For examples see the file `examples_goal_setting.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for goal and sub-goal definition patterns, goal hierarchy, and success criteria.

For examples see the file `examples_risk_assessment.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for risk/cost/benefit evaluation patterns, trade-off analysis, and risk mitigation strategies.

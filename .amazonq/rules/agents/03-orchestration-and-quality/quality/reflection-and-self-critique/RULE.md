...
For examples see the file `examples_reviewer_node.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for Reviewer Node implementation and critique process.
...
For examples see the file `examples_evaluation.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for accuracy checking and validation patterns.
...
For examples see the file `examples_reviewer_node.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for structured critique prompt templates.
...
For examples see the file `examples_evaluation.py` in this folder. When using this rule, add the relevant example file(s) to the chat context. for internal eval metrics and quality scoring patterns.

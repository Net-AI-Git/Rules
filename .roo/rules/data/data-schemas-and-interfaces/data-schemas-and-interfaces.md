...
* **Serialization (Pydantic v2):** Use `.model_dump()`, `.model_dump_json()`, and `.model_validate_json()` for serialization and parsing.
* **Compatibility Note:** If a legacy codepath still uses `.json()` / `.parse_raw()`, treat it as technical debt and migrate gradually to v2 methods.

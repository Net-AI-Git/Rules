---
description: "Implement a new tool for agent use following LangChain tool definition standards with proper Pydantic schemas, documentation, and integration into the tool registry."
---

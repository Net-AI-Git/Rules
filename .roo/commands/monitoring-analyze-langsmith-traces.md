---
description: "Analyze **LangSmith** export JSON (or equivalent) for LLM calls, tools, latency, tokens, cost, and routing. This is the **canonical** trace-metric pass for agent runs."
---

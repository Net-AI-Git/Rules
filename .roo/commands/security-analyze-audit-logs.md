---
description: "Parse and assess **audit trail** JSON (or equivalent) for traceability, anomalies, and governance alignment with structured telemetry expectations. Field-level audit semantics for products using the reference spec: `audit-protocol` *(ref..."
---

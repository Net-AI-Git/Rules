---
description: "Create a new LangGraph node following the four-part structure (READ \u2192 DO \u2192 WRITE \u2192 CONTROL) with proper state management, error handling, and integration into the existing workflow."
---
